...
class AssignmentDeadlineTimer extends StatefulWidget {
  final DateTime endTime;
  const AssignmentDeadlineTimer({super.key, required this.endTime});

  @override
  State<AssignmentDeadlineTimer> createState() =>
      _AssignmentDeadlineTimerState();
}

class _AssignmentDeadlineTimerState extends State<AssignmentDeadlineTimer> {
  Timer? _timer;
  ...
  void _calculateTimeLeft() {
    ...
    if (_timeLeft == Duration.zero) _timer?.cancel();
  }
