...
class AddClassworkDialog extends StatefulWidget {
  ...
  /// Shows the dialog with the Assignment cubit already available in the widget tree.
...
class _AddClassworkDialogState extends State<AddClassworkDialog> {
  ...
  void _submit() {
    ...
    context.read<CreateAssignmentCubit>().addNewClasswork(name, points);
  }

  @override
  Widget build(BuildContext context) {
    return BlocListener<CreateAssignmentCubit, CreateAssignmentState>(
              ...
              child: Column(
                ...
                children: [
                  ...
                  TitledInputField(
                    ...
                    child: AppTextField(
                      hintText: 'e.g. Assignment 1 Task',
                  ...
                  // ── Submit button (shows loading based on Assignment states) ──
